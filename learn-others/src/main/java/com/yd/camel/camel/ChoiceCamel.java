...
public class ChoiceCamel extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        // 通用使用http协议接受消息
        from("jetty:http://0.0.0.0:8082/choiceCamel")
                // 首先送入HttpProcessor，
    ...
    public class HttpProcessor implements Processor {
        ...
        public void process(Exchange exchange) throws Exception {
            exchange.getOut().setBody(exchange.getIn().getBody().toString() + "->HttpProcessor");
        }
    }
    ...
    public class OtherProcessor2 implements Processor {
        @Override
        public void process(Exchange exchange) throws Exception {
            exchange.getOut().setBody(exchange.getIn().getBody().toString() + "->OtherProcessor2");
        }
    ...
    public class OtherProcessor3 implements Processor {
        @Override
        public void process(Exchange exchange) throws Exception {
            exchange.getOut().setBody(exchange.getIn().getBody().toString() + "->OtherProcessor3");
        }
